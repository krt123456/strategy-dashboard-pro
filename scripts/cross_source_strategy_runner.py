...
def run(
    ...
    try:
        ...
        expert_fns = {
            ...
            "bball_coinflip_home": ex.bball_coinflip_home,
            "bball_coinflip_home_wide": ex.bball_coinflip_home_wide,
            "bball_home_edge": ex.bball_home_edge,
            "bball_market_strong": ex.bball_market_strong,
            "bball_market_strong_men": ex.bball_market_strong_men,
            "bball_extreme_fav": ex.bball_extreme_fav,
            "foot_home": ex.foot_home,
            "foot_home_fav": ex.foot_home_fav,
            "foot_big_dog": ex.foot_big_dog,
            "foot_home_dog": ex.foot_home_dog,
            "foot_fade_fav": ex.foot_fade_fav,
            "bsb_away": ex.bsb_away,
            ...
            "omega_tt_cz_night": ex.omega_tt_cz_night,
            "omega_tt_dog_late": ex.omega_tt_dog_late,
            "omega_kbo_dawn": ex.omega_kbo_dawn,
            "omega_clean_basket": ex.omega_clean_basket,
        }
    except Exception:
        expert_fns = {}
